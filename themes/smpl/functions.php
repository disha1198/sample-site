 ...
 */
function smpl_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'smpl_content_width', 640 );
}
add_action( 'after_setup_theme', 'smpl_content_width', 0 );
...
function smpl_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'smpl' ),
		'id'            => 'sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'smpl' ),
...
function smpl_scripts() {
	...
	wp_enqueue_script( 'smpl-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'smpl-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
